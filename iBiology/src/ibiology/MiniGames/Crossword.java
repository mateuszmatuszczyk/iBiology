...
public class Crossword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CrosswordBtn = new javax.swing.JLabel();
        ...
        CrosswordBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ibiology/graphics/MinigamesBtn.png"))); // NOI18N
        CrosswordBtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        CrosswordBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                CrosswordBtnMouseClicked(evt);
            }
        });
        getContentPane().add(CrosswordBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, 200, 220));
        ...
        setSize(new java.awt.Dimension(856, 598));
    ...
    private void MiniBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MiniBMouseClicked
        this.setState(Crossword.ICONIFIED);
    ...
    private void CrosswordBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CrosswordBtnMouseClicked
       CrosswordGame GUI = new CrosswordGame();
       GUI.setVisible(true);
       dispose();
    }//GEN-LAST:event_CrosswordBtnMouseClicked
    ...
    private javax.swing.JLabel CrosswordBtn;
