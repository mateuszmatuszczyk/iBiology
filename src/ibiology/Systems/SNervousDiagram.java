 ...
 * @author x14500057
 */
public class SNervousDiagram extends javax.swing.JFrame {

    /**
     * Creates new form HomePageGUI
     */
    public SNervousDiagram() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(BackBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 460, 170, 70));
        ...
        jTextField1.setText("NervousDiagram");
    ...
    private void MiniBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MiniBMouseClicked
        this.setState(SNervousDiagram.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SNervousDiagram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SNervousDiagram().setVisible(true);
            }
        });
    }
