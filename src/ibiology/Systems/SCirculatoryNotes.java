 ...
 * @author x14500057
 */
public class SCirculatoryNotes extends javax.swing.JFrame {

    /**
     * Creates new form HomePageGUI
     */
    public SCirculatoryNotes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("cIRCULATORY nOTES");
        jTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 120, 180, -1));
        ...
        setSize(new java.awt.Dimension(860, 601));
    ...
    private void MiniBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MiniBMouseClicked
        this.setState(SCirculatoryNotes.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SCirculatoryNotes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SCirculatoryNotes().setVisible(true);
            }
        });
    }
