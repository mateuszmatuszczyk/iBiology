 ...
 * @author x14500057
 */
public class SNervousNotes extends javax.swing.JFrame {

    /**
     * Creates new form HomePageGUI
     */
    public SNervousNotes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("NervousNotes");
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 220, 150, -1));
    ...
    private void MiniBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MiniBMouseClicked
        this.setState(SNervousNotes.ICONIFIED);
    ...
    private void NextBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NextBMouseClicked
        SNervousDiagram GUI = new SNervousDiagram();
        GUI.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SNervousNotes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SNervousNotes().setVisible(true);
            }
        });
    }
